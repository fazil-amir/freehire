...
type Runner struct {
	...
	// heavyMu serializes the catalogue-wide Meilisearch rebuilds boardly-api
...
//
// extraEnv (KEY=value) is added on top of boardly-api's own environment,
...
// what Boardly holds about the provider — its activity, this run
