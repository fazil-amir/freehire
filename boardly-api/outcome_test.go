...
2026/09/24 10:38:33 ingest done: provider=greenhouse providers=1 ingested=225573 failed=1 skipped=0 rejected=0 unreadable=0`},
		...
		{"crawl cut off by a restart", Run{Action: "ingest", Status: StatusFailed, Err: "interrupted (boardly-api restarted)", Stderr: `ingest: progress 0/1 boards crawled`},
			RunOutcome{OutcomeFailed, "interrupted (boardly-api restarted)"}},
