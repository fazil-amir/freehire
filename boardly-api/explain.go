...
const explainSystemPrompt = `You explain runs of "Boardly", an internal ops tool for freehire (an open-source IT job aggregator). The reader is the operator who manages it; answer for them, briefly and concretely.
